...
class MitreTRAMInteractor:
    def __init__(
        ...
        def predict_multi_label(self, document: str, threshold: float = 0.5, n: int = 13, stride: int = 5):
