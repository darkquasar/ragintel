...
class GitHubLoader:
    ...
    def clone_repository(self, source_repo: str, destination_folder: str = None) -> None:
        ...
        if source_repo.endswith(".git"):
            ...
            raise ValueError("Invalid source repository format. Please provide a full GitHub remote URL or a username/repo string.")
        ...
        try:
            with tqdm(unit='B', unit_scale=True, unit_divisor=1024, miniters=1, desc="Cloning", total=100) as progress_bar:
