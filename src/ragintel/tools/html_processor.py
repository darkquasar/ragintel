...
class Processor:
    ...
    def convert_html_to_text(self, docs: list[Document], parser: str = "langchain.html_parser") -> list[Document]:
    ...
    def load_html(self, url: list | str = ..., loader_type: str = "ragintel.simple_html") -> list[Document]:
        """
